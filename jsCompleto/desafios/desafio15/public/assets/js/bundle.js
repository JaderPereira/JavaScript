...
var validaCPF = /*#__PURE__*/function () {
  ...
  return _createClass(validaCPF, [{
    ...
    key: "geraDigito",
    value: function geraDigito(cpfArray) {
      var noveDigitos = cpfArray.split('').slice(0, cpfArray.length).map(Number);
      var sequencia = noveDigitos.length + 2;
      var primeiroDigito = noveDigitos.reduce(function (acumula, valor) {
        sequencia--;
        var calculo = acumula + valor * sequencia;
        return calculo;
      }, 0);
...
var p1 = new validaCPF('22189508711');
...
.resultado {
    ...
    letter-spacing: 3px;
}`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAAA,gBAAgB;AAChB;IACI,SAAS;IACT,UAAU;AACd;AACA;IACI,mCAAmC;IACnC,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,YAAY;IACZ,4DAA4D;AAChE;AACA;IACI,UAAU;IACV,2BAA2B;IAC3B,mBAAmB;IACnB,kBAAkB;AACtB;AACA;IACI,iBAAiB;IACjB,cAAc;IACd,YAAY;AAChB;AACA;IACI,iBAAiB;AACrB;AACA;IACI,cAAc;AAClB;AACA;IACI,WAAW;IACX,YAAY;AAChB;AACA;IACI,YAAY;IACZ,iBAAiB;IACjB,cAAc;IACd,wBAAwB;IACxB,mBAAmB;AACvB","sourcesContent":["@charset \"UTF-8\";\r\n*{\r\n    margin: 0;\r\n    padding: 0;\r\n}\r\nbody{\r\n    background-color: rgb(72, 107, 138);\r\n    display: flex;\r\n    justify-content: center;\r\n    align-items: center;\r\n    height: 97vh;\r\n    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;\r\n}\r\nsection {\r\n    width: 80%;\r\n    background-color: aliceblue;\r\n    border-radius: 15px;\r\n    text-align: center;\r\n}\r\nh1{\r\n    line-height: 55px;\r\n    font-size: 2em;\r\n    margin: 20px;\r\n}\r\np {\r\n    margin: 20px 10px;\r\n}\r\n.relogio {\r\n    font-size: 3em;\r\n}\r\ninput {\r\n    margin: 5px;\r\n    padding: 5px;\r\n}\r\n.resultado {\r\n    margin: 20px;\r\n    font-weight: bold;\r\n    font-size: 2em;\r\n    color: rgb(72, 107, 138);\r\n    letter-spacing: 3px;\r\n}"],"sourceRoot":""}]);
// Exports
...
(function () {
  ...
  cpfGerado.innerHTML = gera.formata(gera.geraNovoCPF());
})();
/******/ })()
;
